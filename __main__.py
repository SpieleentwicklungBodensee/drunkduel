...
class GameScreen(Screen):
    ...
    def draw(self):
        ...
        ledwall.drawText(f'P1: {self.players[0].score}', x=2, y=level.getHeight() * 2, color=(255, 255, 0))
        ledwall.drawText(f'P2: {self.players[1].score}', x=20, y=level.getHeight() * 2, color=(255, 255, 0))
        ...
        ledwall.drawText(f'AMMO: {self.players[0].ammo}', x=2, y=level.getHeight() * 2 + 1, color=ammo1_color)
        ledwall.drawText(f'AMMO: {self.players[1].ammo}', x=20, y=level.getHeight() * 2 + 1, color=ammo2_color)
